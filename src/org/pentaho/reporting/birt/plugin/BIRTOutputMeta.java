...
@Step(
    id = "BIRTOutput", 
    image = "/org/pentaho/reporting/birt/images/birt.png",
    ...
    i18nPackageName = "org.pentaho.reporting.birt.plugin"
)
public class BIRTOutputMeta extends BaseStepMeta implements StepMetaInterface {
  ...
  public Object clone() {
    BIRTOutputMeta retval = (BIRTOutputMeta) super.clone();
  ...
  public StepInterface getStep(StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr, TransMeta transMeta, Trans trans) {
    return new BIRTOutput(stepMeta, stepDataInterface, cnr, transMeta, trans);
  }

  public StepDataInterface getStepData() {
    return new BIRTOutputData();
  }
